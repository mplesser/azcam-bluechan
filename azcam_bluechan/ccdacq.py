...
class CCDACQ(object):
    ...
    def setexposure(self, exposure_time):
        et = exposure_time / 1000.0  #  msec to sec
    ...
    def setconfiguration(
        ...
        azcam.db.tools["exposure"].set_focalplane(
            int(numdet_x), int(numdet_y), int(numamps_x), int(numamps_y), amp_config
        )
    ...
    def sendimage(self, flag, host, port):
        ...
        azcam.db.tools["sendimage"].send_image(localfile, "ccdacq.fits")
        return self.status
