Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 1
...
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 2
...
117    
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 3
...
174       P:0135 P:0135 44F400            MOVE              #'RDA',X0
                        524441
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 4
...
236    
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 5
...
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 6
...
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 7
...
410    
411                             ; *******************************************************************
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 8
...
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 9
...
486                             ; waveforms.asm for MMT Blue Channel gen1
487                             ; 08aug06 last change - R. Tucker
488    
489                             ; *** timing delays ***
490       001770                P_DELAY   EQU     6000                              ; parallel clock delay nsecs (min 50)
491       000064                S_DELAY   EQU     100                               ; S clock delay nsec (min 50)
492       001F40                DWELL     EQU     8000                              ; integration nsec (min 50)
493       00000C                PARMULT   EQU     12                                ; parallel delay multiplier
494    
495                             ; *** voltages ***
496       1.000000E+001         RG_HI     EQU     +10.0                             ; Reset Gate
497       0.000000E+000         RG_LO     EQU     +0.0
498       4.000000E+000         S_HI      EQU     +4.0                              ; Serial clocks
499       -4.000000E+000        S_LO      EQU     -4.0
500       5.100000E+000         SW_HI     EQU     +5.1                              ; Summing Well
501       -4.000000E+000        SW_LO     EQU     -4.0
502       3.000000E+000         P_HI      EQU     +3.0                              ; Parallel clocks
503       -6.200000E+000        P_LO      EQU     -6.2
504       3.000000E+000         TG_HI     EQU     +3.0                              ; Transfer gate
505       -6.200000E+000        TG_LO     EQU     -6.2
506       0.000000E+000         VB5       EQU     0.0                               ; Bias5
507       0.000000E+000         VB6       EQU     0.0                               ; Bias6
508       0.000000E+000         VB7       EQU     0.0                               ; Bias7
509    
510                                       IF      0
517                                       ENDIF
518    
...
536    
537                                       IF      1
538       2.600000E+001         VOD       EQU     +26.0                             ; Vod
539       1.600000E+001         VRD       EQU     +16.0                             ; Vrd
540       1.000000E+000         VOG       EQU     1.0                               ; Vog
541       4.500000E+000         P3_HI     EQU     +4.5
542       -4.700000E+000        P3_LO     EQU     -4.7
543       1.000000E-001         VOFFSET   EQU     +0.1
544                                       ENDIF
545    
546                             ; *** clock rail aliases ***
547       4.000000E+000         S1_HI     EQU     S_HI
548       -4.000000E+000        S1_LO     EQU     S_LO
549       4.000000E+000         S2_HI     EQU     S_HI
550       -4.000000E+000        S2_LO     EQU     S_LO
551       4.000000E+000         S3_HI     EQU     S_HI
552       -4.000000E+000        S3_LO     EQU     S_LO
553       3.000000E+000         P1_HI     EQU     P_HI
554       -6.200000E+000        P1_LO     EQU     P_LO
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  waveforms.asm  Page 10



555       3.000000E+000         P2_HI     EQU     P_HI
556       -6.200000E+000        P2_LO     EQU     P_LO
557                             ;P3_HI          EQU     P_HI
558                             ;P3_LO          EQU     P_LO
559       3.000000E+000         Q1_HI     EQU     P_HI
560       -6.200000E+000        Q1_LO     EQU     P_LO
561       3.000000E+000         Q2_HI     EQU     P_HI
562       -6.200000E+000        Q2_LO     EQU     P_LO
563       4.500000E+000         Q3_HI     EQU     P3_HI
564       -4.700000E+000        Q3_LO     EQU     P3_LO
565    
566                             ; ITL DetChar lab in Kovar tub
567    
568                             ; 0 - amp UL, 123t, 321w, normal mode
569                             ; 0 - amp LR, 321t, 321w, normal mode
570                             ; 0 - amp UL, 123t, 321w, mpp mode
571                             ; 1 - amp LR, 321t, 321w, mpp mode
572    
573                                       DEFINE  CONFIG0_PAR 'p_12_123t.asm'
574                                       DEFINE  CONFIG0_SER 's_2_321w.asm'
575    
576                                       DEFINE  CONFIG1_PAR 'p_12_321t.asm'
577                                       DEFINE  CONFIG1_SER 's_2_321w.asm'
578    
579                                       DEFINE  CONFIG2_PAR 'p_12_123t_mpp.asm'
580                                       DEFINE  CONFIG2_SER 's_2_321w.asm'
581    
582                                       DEFINE  CONFIG3_PAR 'p_12_321t_mpp.asm'
583                                       DEFINE  CONFIG3_SER 's_2_321w.asm'
584    
585                             ; *** end of waveform.asm ***
586    
587                             ; these values are at Y:0 and are overwritten by AzCam
588       Y:0000 Y:0000         DUMMY     DC      0
589       Y:0001 Y:0001         NSDATA    DC      2048
590       Y:0002 Y:0002         NPDATA    DC      2048
591       Y:0003 Y:0003         NSBIN     DC      1
592       Y:0004 Y:0004         NPBIN     DC      1
593       Y:0005 Y:0005                   DC      0
594       Y:0006 Y:0006                   DC      0
595       Y:0007 Y:0007         NSCLEAR   DC      2134
596       Y:0008 Y:0008         NPCLEAR   DC      2048
597       Y:0009 Y:0009         NSPRESKIP DC      16
598                              NSUNDERSCAN
599       Y:000A Y:000A                   DC      0
600       Y:000B Y:000B         NSSKIP    DC      0
601       Y:000C Y:000C         NSPOSTSKIP DC     50
602       Y:000D Y:000D         NSOVERSCAN DC     20
603       Y:000E Y:000E         NPPRESKIP DC      0
604                              NPUNDERSCAN
605       Y:000F Y:000F                   DC      0
606       Y:0010 Y:0010         NPSKIP    DC      0
607       Y:0011 Y:0011         NPPOSTSKIP DC     0
608       Y:0012 Y:0012         NPOVERSCAN DC     0
609       Y:0013 Y:0013         NPXSHIFT  DC      0
610       Y:0014 Y:0014                   DC      0
611       Y:0015 Y:0015         FRAMET    DC      0
612       Y:0016 Y:0016         PREFLASH  DC      0
613       Y:0017 Y:0017                   DC      0
614       Y:0018 Y:0018                   DC      0
615       Y:0019 Y:0019                   DC      0
616       Y:001A Y:001A                   DC      0
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 11



617       Y:001B Y:001B         NSIMAGE   DC      0
618       Y:001C Y:001C         NPIMAGE   DC      0
619       Y:001D Y:001D                   DC      0
620       Y:001E Y:001E                   DC      0
621       Y:001F Y:001F         IDLEONE   DC      1
622    
623                             ; *** these values are at Y:20 and are addresses ***
624       Y:0020 Y:0020         PMULT     DC      PARMULT
625       Y:0021 Y:0021         ACLEAR0   DC      TNOP                              ; Prepare prologue (biases)
626       Y:0022 Y:0022         ACLEAR2   DC      TNOP                              ; Prepare epilogue
627       Y:0023 Y:0023         AREAD0    DC      TNOP                              ; not used
628       Y:0024 Y:0024         AREAD8    DC      TNOP                              ; not used
629       Y:0025 Y:0025         AFPXFER0  DC      TNOP                              ; Fast parallel transfer prologue
630       Y:0026 Y:0026         AFPXFER2  DC      TNOP                              ; Fast parallel transfer epilogue
631       Y:0027 Y:0027         APXFER    DC      PXFER                             ; Parallel transfer - storage only
632       Y:0028 Y:0028         APDXFER   DC      PXFER                             ; Parallel transfer (data) - storage only
633       Y:0029 Y:0029         APQXFER   DC      PQXFER                            ; Parallel transfer - storage and image
634       Y:002A Y:002A         ARXFER    DC      RXFER                             ; Reverse parallel transfer (for focus)
635       Y:002B Y:002B         AFSXFER   DC      FSXFER                            ; Fast serial transfer
636       Y:002C Y:002C         ASXFER0   DC      SXFER0                            ; Serial transfer prologue
637       Y:002D Y:002D         ASXFER1   DC      SXFER1                            ; Serial transfer ( * colbin-1 )
638       Y:002E Y:002E         ASXFER2   DC      SXFER2                            ; Serial transfer epilogue - no data
639       Y:002F Y:002F         ASXFER2D  DC      SXFER2                            ; Serial transfer epilogue - data
640       Y:0030 Y:0030         ADACS     DC      BIAS
641    
642                             ;  *** CCD clock select codes ***
643       000000                RG        EQU     $000000                           ; Reset gate -10-+16
644       000100                S1        EQU     $000100                           ; Serial clock phase 1 (-10:+10)
645       000200                S2        EQU     $000200                           ; Serial clock phase 2 (-10:+10)
646       000300                S3        EQU     $000300                           ; Serial clock phase 3 (-10:+10)
647       000400                SW        EQU     $000400                           ; Output Summing Well (-10:+10)
648       000500                P1        EQU     $000500                           ; Parallel clock phase 1 (-10:+10)
649       000600                P2        EQU     $000600                           ; Parallel clock phase 2 (-10:+10)
650       000700                P3        EQU     $000700                           ; Parallel clock phase 3 (-10:+10)
651       000800                TG        EQU     $000800                           ; Transfer gate (-10:+10)
652       000900                Q1        EQU     $000900                           ; Q1 (-10:+10)
653       000A00                Q2        EQU     $000A00                           ; Q2 (-10:+10)
654       000B00                Q3        EQU     $000B00                           ; Q3 (-10:+10)
655       0000FE                OFFSET    EQU     INV-1                             ; Video processor offset (-5:+5)
656       0000FD                OD        EQU     INV-2                             ; Output Drain (0:30)
657       0000FB                RD        EQU     INV-4                             ; Reset Drain (0:20)
658       0000F7                B3        EQU     INV-8                             ; B3 (0:30)
659       0000EF                OG        EQU     INV-16                            ; Output Gate (-5:+5)
660       0000DF                B5        EQU     INV-32                            ; B5 (-10:+10)
661       0000BF                B6        EQU     INV-64                            ; B6 (-10:+10)
662       00007F                B7        EQU     INV-128                           ; B7 (-10:+10)
663    
664                             ; *** change clock decimal voltages to counts ***
665       00003B                RGH       EQU     RG+255-@CVI((RG_HI+10.0)/26.0*255)
666       00009D                RGL       EQU     RG+255-@CVI((RG_LO+10.0)/26.0*255)
667       00014D                S1H       EQU     S1+255-@CVI((S1_HI+10.0)/20.0*255)
668       0001B3                S1L       EQU     S1+255-@CVI((S1_LO+10.0)/20.0*255)
669       00024D                S2H       EQU     S2+255-@CVI((S2_HI+10.0)/20.0*255)
670       0002B3                S2L       EQU     S2+255-@CVI((S2_LO+10.0)/20.0*255)
671       00034D                S3H       EQU     S3+255-@CVI((S3_HI+10.0)/20.0*255)
672       0003B3                S3L       EQU     S3+255-@CVI((S3_LO+10.0)/20.0*255)
673       00043F                SWH       EQU     SW+255-@CVI((SW_HI+10.0)/20.0*255)
674       0004B3                SWL       EQU     SW+255-@CVI((SW_LO+10.0)/20.0*255)
675       00055A                P1H       EQU     P1+255-@CVI((P1_HI+10.0)/20.0*255)
676       0005CF                P1L       EQU     P1+255-@CVI((P1_LO+10.0)/20.0*255)
677       00065A                P2H       EQU     P2+255-@CVI((P2_HI+10.0)/20.0*255)
678       0006CF                P2L       EQU     P2+255-@CVI((P2_LO+10.0)/20.0*255)
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 12



679       000747                P3H       EQU     P3+255-@CVI((P3_HI+10.0)/20.0*255)
680       0007BC                P3L       EQU     P3+255-@CVI((P3_LO+10.0)/20.0*255)
681       00085A                TGH       EQU     TG+255-@CVI((TG_HI+10.0)/20.0*255)
682       0008CF                TGL       EQU     TG+255-@CVI((TG_LO+10.0)/20.0*255)
683       00095A                Q1H       EQU     Q1+255-@CVI((Q1_HI+10.0)/20.0*255)
684       0009CF                Q1L       EQU     Q1+255-@CVI((Q1_LO+10.0)/20.0*255)
685       000A5A                Q2H       EQU     Q2+255-@CVI((Q2_HI+10.0)/20.0*255)
686       000ACF                Q2L       EQU     Q2+255-@CVI((Q2_LO+10.0)/20.0*255)
687       000B47                Q3H       EQU     Q3+255-@CVI((Q3_HI+10.0)/20.0*255)
688       000BBC                Q3L       EQU     Q3+255-@CVI((Q3_LO+10.0)/20.0*255)
689    
690                             ; *** change bias decimal voltages to counts ***
691       000082                VOFFD     EQU     @CVI((VOFFSET+5.0)/10.0*255)
692       0000F8                VODD      EQU     @CVI((VOD+00.0)/26.7*255)
693       0000DB                VRDD      EQU     @CVI((VRD+00.0)/18.6*255)
694       000099                VOGD      EQU     @CVI((VOG+05.0)/10.0*255)
695       00007F                VB5D      EQU     @CVI((VB5+10.0)/20.0*255)
696       00007F                VB6D      EQU     @CVI((VB6+10.0)/20.0*255)
697       00007F                VB7D      EQU     @CVI((VB7+10.0)/20.0*255)
698    
699                             ; BIAS and CLEAR0 code
700                             BIAS
701                             ; Set DC bias supply voltages with DACs
702       Y:0031 Y:0031         CLEAR0    DC      ECLEAR0-CLEAR0-2
703                             ; Set the bias DACs
704                             ; Set the video offset voltage
705       Y:0032 Y:0032                   DC      CCD+BIASDAT+VOFFD
706       Y:0033 Y:0033                   DC      CCD+DACTIME*DELAY+BIASSEL+OFFSET
707       Y:0034 Y:0034                   DC      CCD+BIASSEL+INV
708                             ; Set CCD Output Drain voltage Vod
709       Y:0035 Y:0035                   DC      CCD+BIASDAT+VODD
710       Y:0036 Y:0036                   DC      CCD+DACTIME*DELAY+BIASSEL+OD
711       Y:0037 Y:0037                   DC      CCD+BIASSEL+INV
712                             ; Set CCD Reset Drain voltage Vrd
713       Y:0038 Y:0038                   DC      CCD+BIASDAT+VRDD
714       Y:0039 Y:0039                   DC      CCD+DACTIME*DELAY+BIASSEL+RD
715       Y:003A Y:003A                   DC      CCD+BIASSEL+INV
716                             ; Set CCD Output Transfer Gate voltage Vog
717       Y:003B Y:003B                   DC      CCD+BIASDAT+VOGD
718       Y:003C Y:003C                   DC      CCD+DACTIME*DELAY+BIASSEL+OG
719       Y:003D Y:003D                   DC      CCD+BIASSEL+INV
720                             ; Set B5
721       Y:003E Y:003E                   DC      CCD+BIASDAT+VB5D
722       Y:003F Y:003F                   DC      CCD+DACTIME*DELAY+BIASSEL+B5
723       Y:0040 Y:0040                   DC      CCD+BIASSEL+INV
724                             ; Set B6
725       Y:0041 Y:0041                   DC      CCD+BIASDAT+VB6D
726       Y:0042 Y:0042                   DC      CCD+DACTIME*DELAY+BIASSEL+B6
727       Y:0043 Y:0043                   DC      CCD+BIASSEL+INV
728                             ; Set B7
729       Y:0044 Y:0044                   DC      CCD+BIASDAT+VB7D
730       Y:0045 Y:0045                   DC      CCD+DACTIME*DELAY+BIASSEL+B7
731       Y:0046 Y:0046                   DC      CCD+BIASSEL+INV
732                             ECLEAR0
733    
734                             ; *** shorthand for waveforms ***
735       000077                P_DEL     EQU     @CVI((P_DELAY/50)-1)
736       000001                S_DEL     EQU     @CVI((S_DELAY/50)-1)
737       00009F                DWEL      EQU     @CVI((DWELL/50)-1)
738       770000                PCLK      EQU     CCD+P_DEL*DELAY
739       010000                SCLK      EQU     CCD+S_DEL*DELAY
740    
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  tim1.asm  Page 13



741                             ; *** timing NOP ***
742       Y:0047 Y:0047         TNOP      DC      ETNOP-TNOP-2
743       Y:0048 Y:0048                   DC      $000F00
744       Y:0049 Y:0049                   DC      $000F00
745                             ETNOP
746    
747                             ; *** code for generating waveforms ***
748                                       IF      0
753                                       ENDIF
754    
755                                       IF      0
...
768    
769                                       IF      1
770       Y:004A Y:004A         PXFER     DC      EPXFER-PXFER-2
771                                       INCLUDE "p_12_321t_mpp.asm"
772                             ; p_12_321t_mpp.asm
773       Y:004B Y:004B                   DC      PCLK+TGH                          ; TGH
774       Y:004C Y:004C                   DC      PCLK+P1H                          ; 1
775       Y:004D Y:004D                   DC      PCLK+P3H                          ; 1+3
776       Y:004E Y:004E                   DC      PCLK+P1L                          ; 3
777       Y:004F Y:004F                   DC      PCLK+P2H                          ; 3+2
778       Y:0050 Y:0050                   DC      PCLK+P3L                          ; 2
779       Y:0051 Y:0051                   DC      PCLK+P1H                          ; 2+1
780       Y:0052 Y:0052                   DC      PCLK+P2L                          ; 1
781       Y:0053 Y:0053                   DC      PCLK+P1L                          ; MPP
782       Y:0054 Y:0054                   DC      PCLK+TGL                          ; TGL
783                             EPXFER
784                                       INCLUDE "s_2_321w.asm"
785                             ; s_2_321w.asm generic SW
786    
787       Y:0055 Y:0055         FSXFER    DC      EFSXFER-FSXFER-2
788       Y:0056 Y:0056                   DC      SCLK+RGH                          ; reset
789       Y:0057 Y:0057                   DC      SCLK+RGL
790       Y:0058 Y:0058                   DC      SCLK+SWH
791       Y:0059 Y:0059                   DC      SCLK+S1H                          ; 2+1
792       Y:005A Y:005A                   DC      SCLK+S2L                          ; 1
793       Y:005B Y:005B                   DC      SCLK+S3H                          ; 1+3
794       Y:005C Y:005C                   DC      SCLK+S1L                          ; 3
795       Y:005D Y:005D                   DC      SCLK+S2H                          ; 3+2
796       Y:005E Y:005E                   DC      SCLK+S3L                          ; 2
797       Y:005F Y:005F                   DC      SCLK+SWL
798                             EFSXFER
799    
800       Y:0060 Y:0060         SXFER0    DC      ESXFER0-SXFER0-2
801       Y:0061 Y:0061                   DC      VP+%00011101
802       Y:0062 Y:0062                   DC      SCLK+RGH                          ; reset
803       Y:0063 Y:0063                   DC      SCLK+RGL
804       Y:0064 Y:0064                   DC      SCLK+SWH
805       Y:0065 Y:0065                   DC      SCLK+S1H                          ; 2+1
806       Y:0066 Y:0066                   DC      SCLK+S2L                          ; 1
807       Y:0067 Y:0067                   DC      SCLK+S3H                          ; 1+3
808       Y:0068 Y:0068                   DC      SCLK+S1L                          ; 3
809       Y:0069 Y:0069                   DC      SCLK+S2H                          ; 3+2
810       Y:006A Y:006A                   DC      SCLK+S3L                          ; 2
811                             ESXFER0
812    
813       Y:006B Y:006B         SXFER1    DC      ESXFER1-SXFER1-2
814       Y:006C Y:006C                   DC      SCLK+S1H                          ; 2+1
Motorola DSP56000 Assembler  Version 6.3.0   108-08-13  09:28:23  s_2_321w.asm  Page 14



815       Y:006D Y:006D                   DC      SCLK+S2L                          ; 1
816       Y:006E Y:006E                   DC      SCLK+S3H                          ; 1+3
817       Y:006F Y:006F                   DC      SCLK+S1L                          ; 3
818       Y:0070 Y:0070                   DC      SCLK+S2H                          ; 3+2
819       Y:0071 Y:0071                   DC      SCLK+S3L                          ; 2
820                             ESXFER1
821    
822       Y:0072 Y:0072         SXFER2    DC      ESXFER2-SXFER2-2
823                                       INTNOISE
832       Y:007A Y:007A                   DC      SCLK+SWL
833                                       INTSIGNAL
840                             ESXFER2
841                                       ENDIF
842    
